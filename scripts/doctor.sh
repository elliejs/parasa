...
CONF
	...
	local script
	for script in helpers.sh workspace.sh new_foundation.sh update_foundation.sh new_system.sh new_container.sh destroy_container.sh destroy_foundation.sh deploy_system.sh deploy_container.sh diff.sh save.sh update.sh finalize_update.sh doctor.sh menu.sh; do
